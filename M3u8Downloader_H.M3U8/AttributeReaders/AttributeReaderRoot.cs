...
using System.Linq;
using System;
using M3u8Downloader_H.M3U8.Collection;
...
namespace M3u8Downloader_H.M3U8.AttributeReaders
{
    public partial class AttributeReaderRoot
    {
        ...
        public IAttributeReaderCollection AttributeReaders
        {
            get => new AttributeReaderCollection(attributeReaders.ToDictionary(x => x.Key, x => (IAttributeReader)Activator.CreateInstance(x.Value)!));
        }
