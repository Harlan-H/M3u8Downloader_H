...
{
    public class M3UFileReaderManager(HttpClient httpClient, IM3uFileReader M3u8FileReader)
    {
        ...
        public async Task<IM3uFileInfo> GetM3u8FileInfo(TimeSpan timeouts, CancellationToken cancellationToken = default)
        {
            ...
            return await GetM3u8FileInfoInternal(DownloadParam.RequestUrl, DownloadParam.Headers ?? DownloaderSetting.Headers, cancellationTokenSource.Token);
        }
