...
namespace M3u8Downloader_H.Common.Services
{
    public sealed  class HttpClientWrapper(
        ...
        TimeOutOptions options) : IHttpClientWrapper
    {
        public HttpClientWrapper(HttpClient httpClient ,long timeout) : this(httpClient,new TimeOutOptions(timeout)) { }

        public HttpClientWrapper(HttpClient httpClient) : this(httpClient, new TimeOutOptions(30)) { }
